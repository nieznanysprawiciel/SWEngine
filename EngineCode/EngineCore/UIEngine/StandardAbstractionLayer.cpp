...
namespace STANDARD_LAYERS
{
	...
	std::vector< InputMapping > PROTOTYPE_BUTTONS_mapping =
	{
		...
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::TURN_RIGHT, KeyboardState::PHYSICAL_KEYS::KEY_E },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::TURN_LEFT, KeyboardState::PHYSICAL_KEYS::KEY_Q },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::UP, KeyboardState::PHYSICAL_KEYS::KEY_R },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::DOWN, KeyboardState::PHYSICAL_KEYS::KEY_F },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::TURN_UP, KeyboardState::PHYSICAL_KEYS::KEY_T },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::TURN_DOWN, KeyboardState::PHYSICAL_KEYS::KEY_G },
		...
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::ENABLE_MOVE_X, KeyboardState::PHYSICAL_KEYS::KEY_X },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::ENABLE_MOVE_Y, KeyboardState::PHYSICAL_KEYS::KEY_Y },
		{ DEVICE_IDs::KEYBOARD, PROTOTYPE_BUTTONS::ENABLE_MOVE_Z, KeyboardState::PHYSICAL_KEYS::KEY_Z },
	...
	std::vector< InputMapping > PROTOTYPE_AXES_mapping =
	{
		...
		{ DEVICE_IDs::MOUSE, PROTOTYPE_AXES::ZOOM, MouseState::PHYSICAL_AXES::WHEEL }
	};
