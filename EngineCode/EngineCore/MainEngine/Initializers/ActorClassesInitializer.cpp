...
RTTR_REGISTRATION
{
	...
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( uint64 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( uint32 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( uint16 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( uint8 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( int64 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( int32 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( int16 );
	RTTR_REGISTRATION_STANDARD_TYPE_VARIANTS( int8 );
