...
void interpolate_position( float time_lag, const Dynamic_object* object, DirectX::XMVECTOR& result_vector );
void interpolate_orientation( float time_lag, const Dynamic_object* object, DirectX::XMVECTOR& result_vector );
...
*/
inline void interpolate_position( float time_lag, const Dynamic_object* object, DirectX::XMVECTOR& result_vector )
{
...
@param[out] transform_matrix Zmienna, w której zostanie umieszczona interpolowana wartoœæ.
*/
inline void interpolate_orientation( float time_lag, const Dynamic_object* object, DirectX::XMVECTOR& result_vector )
{
